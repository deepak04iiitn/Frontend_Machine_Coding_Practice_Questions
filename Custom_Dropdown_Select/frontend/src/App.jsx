...
const SimpleTailwindDropdown = ({
  ...
  return (
    <div className="relative w-full max-w-xs" ref={dropdownRef} onKeyDown={handleKeyDown}>
      <button
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-10 flex items-center justify-center">
      <div className="w-full max-w-md">
        <h1 className="text-2xl font-semibold mb-4">Framework Dropdown</h1>
        <SimpleTailwindDropdown
          options={options}
          value={selectedValue}
          onChange={setSelectedValue}
        ...
        {selectedValue && (
          <p className="mt-4 text-sm text-gray-700">
            Selected: <strong>{options.find(o => o.value === selectedValue)?.label}</strong>
          </p>
        )}
      </div>
    </div>
